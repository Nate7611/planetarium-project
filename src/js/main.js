...
const planets = [
  ...
  { name: 'Saturn', arrived: false, left: false, position: 1028.88, endPosition: 1029.12, diameter: '74,897 mi (120,536 km)', temperature: '-220°F (-140°C)', moons: '146', dayLength: '0.444 Earth Days', funFact: "Despite Saturn's rings being around 175,000 miles (282,000 km) wide, their thickness is less than the length of a football field.", button: document.getElementById('discovered-planets__saturn') },
  { name: 'Uranus', arrived: false, left: false, position: 2066.968, endPosition: 2067.032, diameter: '31,763 mi (51,118 km)', temperature: '-320°F (-195°C)', moons: '27', dayLength: '0.718 Earth Days', funFact: 'Uranus is unique because it rotates on its side, with its axis tilted by about 98 degrees.', button: document.getElementById('discovered-planets__uranus') },
  { name: 'Neptune', arrived: false, left: false, position: 3234.968, endPosition: 3235.032, diameter: '30,775 mi (49,528 km)', temperature: '-330°F (-200°C)', moons: '14', dayLength: '0.671 Earth Days', funFact: 'Neptune is known for its strong winds, the fastest in the Solar System, reaching speeds of more than 1,200 mph (2,000 km/h).', button: document.getElementById('discovered-planets__neptune') },
  { name: 'Pluto', arrived: false, left: false, position: 4219.9978, endPosition: 4220.0022, diameter: '1,476 mi (2,376 km)', temperature: '-375°F (-225°C)', moons: '5', dayLength: '6.39 Earth Days', funFact: 'Pluto was once considered the ninth planet in our Solar System before being reclassified as a dwarf planet in 2006.', button: document.getElementById('discovered-planets__pluto') }
];
...
const fastTravel = {
  mercury: document.getElementById('discovered-planets__mercury'),
  venus: document.getElementById('discovered-planets__venus'),
  earth: document.getElementById('discovered-planets__earth'),
  moon: document.getElementById('discovered-planets__moon'),
  mars: document.getElementById('discovered-planets__mars'),
  jupiter: document.getElementById('discovered-planets__jupiter'),
  saturn: document.getElementById('discovered-planets__saturn'),
  uranus: document.getElementById('discovered-planets__uranus'),
  neptune: document.getElementById('discovered-planets__neptune'),
  pluto: document.getElementById('discovered-planets__pluto')
};
...
for (const i in fastTravel) {
  fastTravel[i].addEventListener('click', function () {
    ...
    if (planet) {
      planet.arrived = false;
      planet.left = false;
      voyagerModel.position.z = planet.position;
...
fastTravelButton.addEventListener('click', () => {
  if (fastTravelElement.style.display == 'block') {
    fastTravelElement.style.display = 'none';
  }
  else {
    fastTravelElement.style.display = 'block';
    fastTravelElement.style.animationName = 'reveal';
  }
});
